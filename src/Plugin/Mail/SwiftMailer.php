...
class SwiftMailer implements MailInterface, ContainerFactoryPluginInterface {
  ...
  /**
   * The asset library discovery parser.
   *
   ...
   *   The filesystem service.
   */
  public function __construct(TransportFactoryInterface $transport_factory, ImmutableConfig $message, LoggerInterface $logger, RendererInterface $renderer, ModuleHandlerInterface $module_handler, MailManagerInterface $mail_manager, LibraryDiscoveryParser $library_discover_parser, AssetResolverInterface $asset_resolver, FileSystem $file_system) {
